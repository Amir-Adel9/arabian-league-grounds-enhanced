    ...
    <div className='flex flex-col items-center gap-5 mt-20 mb-16 lg:mb-0'>
      ...
      <div className='flex gap-5 justify-center'>
        <div className='flex flex-col items-center gap-3'>
          <h3 className='font-kanit text-3xl mt-5'>Top</h3>
        ...
        <div className='flex flex-col items-center gap-3'>
          <h3 className='font-kanit text-3xl mt-5'>Jungle</h3>
          <div className='flex flex-col gap-2 justify-center items-center'>
        ...
        <div className='flex flex-col items-center gap-3'>
          <h3 className='font-kanit text-3xl mt-5'>Mid</h3>
          <div className='flex flex-col gap-2 justify-center items-center'>
        ...
        <div className='flex flex-col items-center gap-3'>
          <h3 className='font-kanit text-3xl mt-5'>Bot</h3>
          <div className='flex flex-col gap-2 justify-center items-center'>
        ...
        <div className='flex flex-col items-center gap-3'>
          <h3 className='font-kanit text-3xl mt-5'>Support</h3>
          <div className='flex flex-col gap-2 justify-center items-center'>
      ...
      <div className='flex flex-col gap-5'>
        ...
        {
          <div>
            <h3 className='font-kanit text-3xl mt-5 text-center'>
              Fantasy Points
            </h3>
            <div className='flex flex-row gap-5 justify-center items-center'>
