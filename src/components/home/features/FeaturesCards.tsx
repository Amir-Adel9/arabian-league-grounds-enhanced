  ...
  return (
    <>
      <motion.div
        ...
        viewport={{ once: true }}
        className='relative flex flex-col items-center justify-around bg-secondary text-center  lg:w-1/4 xl:w-1/5 h-[500px] cursor-pointer rounded-2xl group hover:scale-105 duration-300 hover:text-secondary hover:rounded-sm p-3 shadow-2xl'
      >
        ...
        <div className='z-20'>
          <p className='font-rubik  '>
            <Balancer>
              ...
              Grounds community. Earn points by predicting matches correctly and
              having fantasy matches.
            </Balancer>
          </p>
        </div>
        <span className='bg-primary text-secondary group-hover:bg-secondary group-hover:text-primary group-hover:rounded-none z-20 font-rubik font-b py-2 px-3 cursor-pointer rounded-sm duration-300 hover:scale-105 hover:opacity-95'>
